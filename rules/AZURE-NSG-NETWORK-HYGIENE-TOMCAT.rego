...
check_port(resource) { 
	resource.source_port_range == "8080"
}
...
#This one for individual string type
check_port(resource) { 
	resource.destination_port_range == "8080"
}
#this one for individual num type
check_port(resource) { 
	resource.destination_port_range == 8080
...
deny[msg] {
	...
	msg := {
		# Mandatory fields
		"publicId": "AZURE-NSG-NETWORK-HYGIENE-TOMCAT", #please change the public id
		"title": "Network Hygiene TOMCAT (tcp 8080)",
		"severity": "high",
