...
check_gcp_banned_protocol_p2p(resource) {
    # Expand the range of ports and compare with banPorts
    banPorts := [6881, 6882, 6883, 6884, 6885, 6886, 6887, 6888, 6889]
