...
check_port_143(resource) { 
	resource.source_port_range == "143"
}
...
#This one for individual string type
check_port_143(resource) { 
	resource.destination_port_range == "143"
}
#this one for individual num type
check_port_143(resource) { 
	resource.destination_port_range == 143
