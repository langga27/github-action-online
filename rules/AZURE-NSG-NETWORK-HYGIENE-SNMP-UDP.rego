...
check_port_162(resource) { 
	resource.source_port_range == "162"
}
...
#This one for individual string type
check_port_162(resource) { 
	resource.destination_port_range == "162"
}
#this one for individual num type
check_port_162(resource) { 
	resource.destination_port_range == 162
