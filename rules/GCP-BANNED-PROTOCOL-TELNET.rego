...
check_gcp_banned_protocol_telnet(resource) {
...
deny[msg] {
    ...
    msg := {
        # Mandatory fields
        "name": [name],
        "publicId": "GCP-BANNED-PROTOCOL-TELNET",
        "title": "Banned Protocols TELNET (tcp 23)",
        "severity": "high",
        ...
        "impact": "Insecure remote access protocol where both data and credentials are sent in clear which can be intercepted during transmission.",
