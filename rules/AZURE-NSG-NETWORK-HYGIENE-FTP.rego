...
check_port_ftp_data(resource) { 
	resource.source_port_range == "21"
}

check_port_ftp_data(resource) { 
	resource.source_port_range == "20"
}
...
#This one for individual string type
check_port_ftp_data(resource) { 
	resource.destination_port_range == "21"
}

check_port_ftp_data(resource) { 
	resource.destination_port_range == "20"
}
#this one for individual num type
check_port_ftp_data(resource) { 
	resource.destination_port_range == 21
