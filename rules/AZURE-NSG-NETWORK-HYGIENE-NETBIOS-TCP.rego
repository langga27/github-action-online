...
check_port_netbios(resource) { 
	resource.source_port_range == "139"
}
...
check_port_netbios(resource) { 
	resource.destination_port_range == "139"
}
#this one for individual num type
check_port_netbios(resource) { 
	resource.destination_port_range == 137
