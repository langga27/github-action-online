...
check_port_135(resource) { 
	resource.source_port_range == "135"
}
...
#This one for individual string type
check_port_135(resource) { 
	resource.destination_port_range == "135"
}
#this one for individual num type
check_port_135(resource) { 
	resource.destination_port_range == 135
